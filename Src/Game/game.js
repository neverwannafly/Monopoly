...
class Game {
    ...
    drawBoard() {
        ...
        `<tr>
            <td id="20" class="corner-cell highlight"><div class="content"><div class="bigInfo verticalCenter">${this.board[20].name}</div></div></td>
            ...
            <td id="30" class="corner-cell highlight"><div class="content"><div class="bigInfo verticalCenter">${this.board[30].name}</div></div></td>
        </tr>
        <tr>
            <td id="19" class="inverted-cell highlight"><div class="content row1"><div class="color" style="background-color:#${this.board[19].color}"></div><div class="info">${this.board[19].name}<div class="cost">${this.currency}${this.board[19].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="31" class="inverted-cell highlight"><div class="content row3"><div class="color" style="background-color:#${this.board[31].color}"></div><div class="info">${this.board[31].name}<div class="cost">${this.currency}${this.board[31].cost}</div></div></div></td>
        </tr>
        <tr>
            <td id="18" class="inverted-cell highlight"><div class="content row1"><div class="color" style="background-color:#${this.board[18].color}"></div><div class="info">${this.board[18].name}<div class="cost">${this.currency}${this.board[18].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="32" class="inverted-cell highlight"><div class="content row3"><div class="color" style="background-color:#${this.board[32].color}"></div><div class="info">${this.board[32].name}<div class="cost">${this.currency}${this.board[32].cost}</div></div></div></td>
        </tr>
        <tr>
            <td id="17" class="inverted-cell highlight"><div class="content row1"><div class="bigInfo vertcialCenter">${this.board[17].name}</div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="33" class="inverted-cell highlight"><div class="content row3"><div class="bigInfo verticalCenter">${this.board[33].name}</div></div></td>
        </tr>
        <tr>
            <td id="16" class="inverted-cell highlight"><div class="content row1"><div class="color" style="background-color:#${this.board[16].color}"></div><div class="info">${this.board[16].name}<div class="cost">${this.currency}${this.board[16].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="34" class="inverted-cell highlight"><div class="content row3"><div class="color" style="background-color:#${this.board[34].color}"></div><div class="info">${this.board[34].name}<div class="cost">${this.currency}${this.board[34].cost}</div></div></div></td>
        </tr>
        <tr>
            <td id="15" class="inverted-cell highlight"><div class="content row1"><div class="bigInfo">${this.board[15].name}<div class="cost">${this.currency}${this.board[15].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="35" class="inverted-cell highlight"><div class="content row3"><div class="bigInfo">${this.board[35].name}<div class="cost">${this.currency}${this.board[35].cost}</div></div></div></td>
        </tr>
        <tr>
            <td id="14" class="inverted-cell highlight"><div class="content row1"><div class="color" style="background-color:#${this.board[14].color}"></div><div class="info">${this.board[14].name}<div class="cost">${this.currency}${this.board[14].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="36" class="inverted-cell highlight"><div class="content row3"><div class="info verticalCenter">${this.board[36].name}</div></div></td>
        </tr>
        <tr>
            <td id="13" class="inverted-cell highlight"><div class="content row1"><div class="color" style="background-color:#${this.board[13].color}"></div><div class="info">${this.board[13].name}<div class="cost">${this.currency}${this.board[13].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="37" class="inverted-cell highlight"><div class="content row3"><div class="color" style="background-color:#${this.board[37].color}"></div><div class="info">${this.board[37].name}<div class="cost">${this.currency}${this.board[37].cost}</div></div></div></td>
        </tr>
        <tr>
            <td id="12" class="inverted-cell highlight"><div class="content row1"><div class="color" style="background-color:#${this.board[12].color}"></div><div class="info">${this.board[12].name}<div class="cost">${this.currency}${this.board[12].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="38" class="inverted-cell highlight"><div class="content row3"><div class="bigInfo">${this.board[38].name}<div class="cost">${this.currency}${this.board[38].penalty}</div></div></div></td>
        </tr>
        <tr>
            <td id="11" class="inverted-cell highlight"><div class="content row1"><div class="color" style="background-color:#${this.board[11].color}"></div><div class="info">${this.board[11].name}<div class="cost">${this.currency}${this.board[11].cost}</div></div></div></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            ...
            <td class="middle-cell empty"></td>
            <td class="middle-cell empty"></td>
            <td id="39" class="inverted-cell highlight"><div class="content row3"><div class="color" style="background-color:#${this.board[39].color}"></div><div class="info">${this.board[39].name}<div class="cost">${this.currency}${this.board[39].cost}</div></div></div></td>
        </tr>
        <tr>
            <td id="10" class="corner-cell highlight"><div class="content"><div class="bigInfo verticalCenter">${this.board[10].name}</div></div></td>
            ...
            <td id="0" class="corner-cell highlight"><div class="content"><div class="bigInfo verticalCenter">${this.board[0].name}</div></div></td>
        </tr>`;
